...
public class SimWindow extends JFrame implements TrafficSimulator.Listener {
	...
	private void addBars() {
		...
		SimulatorAction insertEvents = new SimulatorAction("Insert Events",
				"events.png", "Inserta eventos en simulador", KeyEvent.VK_I,
				"control I", () -> {
					control.simulador()
							.leerDatosSimulacion(eventsArea.flujoLectura());
					eventsArea.setText("");
				});
		...
		SimulatorAction restartSim = new SimulatorAction("Reset Sim",
				"reset.png", "Reiniciar simulador", KeyEvent.VK_R, "control R",
		...
		SimulatorAction report = new SimulatorAction("Generate", "report.png",
				...
				() -> control.simulador()
						.generaInforme(reportsArea.flujoEscritura()));

		SimulatorAction clearReport = new SimulatorAction("Clear",
				"delete_report.png", "Borra reports", KeyEvent.VK_D,
				"control D", () -> reportsArea.setText(""));

		SimulatorAction saveReport = new SimulatorAction("Save Report",
				"save_report.png", "Guarda reports", KeyEvent.VK_S, "control S",
	...
	public void addUpperPanel() {
		...
		mainPanel = new JSplitPane(JSplitPane.VERTICAL_SPLIT, upperPanel,
				bottomSplit);

		eventsArea = new TextEditor("Events", true, fc);
		eventsArea
				.setText(TextEditor.readFile(new File(control.getInputPath())));
	...
	public void addLowerPanel() {
		...
		String[] vehicDescrib = {"ID", "Road", "Location", "Speed", "Km",
		...
		bottomSplit = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, tablePanel,
				graphComp);
	}
	...
	public void registered(UpdateEvent ue) {
		...
		List<Describable> v = (List<Describable>) (List) ue.getRoadMap()
				.getVehicles();
		List<Describable> r = (List<Describable>) (List) ue.getRoadMap()
				.getRoads();
		List<Describable> j = (List<Describable>) (List) ue.getRoadMap()
				.getJunctions();
	...
	public void reset(UpdateEvent ue) {
		...
		statusBarReport
				.setText(" Se ha reiniciado el estado de la simulación.");
	}
	...
	public void advanced(UpdateEvent ue) {
		...
		statusBarReport
				.setText(" Se ha avanzado en el estado de la simulación");
	}
