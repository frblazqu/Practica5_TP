...
public class TextEditor extends JPanel {
	...
	private void initGUI() {
		...
		if (editable) {
			...
			SimulatorAction loadOption = new SimulatorAction("Load",
					"Cargar eventos", KeyEvent.VK_L, () -> loadFile());

			SimulatorAction saveOption = new SimulatorAction("Save",
					"Guardar eventos", KeyEvent.VK_S, () -> saveFile());

			SimulatorAction clearOption = new SimulatorAction("Clear",
					"Vaciar eventos", KeyEvent.VK_B,
					() -> textArea.setText(""));
