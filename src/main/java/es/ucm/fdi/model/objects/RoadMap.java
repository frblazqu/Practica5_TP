...
public class RoadMap {
	...
	public Road getRoad(String junctionIniId, String junctionFinId)
		...
		if (connectedJunctions.containsKey(junctionIniId)) {
			List<ConexionCruces> conexionAux = connectedJunctions
					.get(junctionIniId);
			...
			throw new IllegalArgumentException(
					"No hay conexión entre el los cruces " + junctionIniId
							+ " y " + junctionFinId);
		} else
			throw new IllegalArgumentException("El cruce " + junctionIniId
					+ " no existe o no está comunicado");
	}
