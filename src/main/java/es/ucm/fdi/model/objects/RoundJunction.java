...
public class RoundJunction extends Junction {/*
	...
	public void inicializaSemaforo() {
		tiempoConsumido = intervalosVerde.get(incomingRoadIds
				.get(numCarreterasEntrantes - 1)) - 1;
		ticksPasaVehiculo = 1;
	...
	public String colaCruce() {
		...
		String cola = "";
		int aux = intervalosVerde.get(incomingRoadIds.get(semaforo)) - tiempoConsumido;
	...
	public String estadoVerde() {
		...
		String aux = "";
		int timeLeft = intervalosVerde.get(incomingRoadIds.get(semaforo))
				- tiempoConsumido;
		aux += "[";
		if (semaforo != -1) {
