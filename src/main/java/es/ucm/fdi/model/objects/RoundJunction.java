...
public class RoundJunction
	 ...
	 */
	public RoundJunction(String junction_id, int minDurationVerde,
	...
	public void avanzarSemaforo() {
		...
		if (tiempoConsumido == intervalosVerde
				.get(incomingRoadIds.get(semaforo))) {
	...
	protected String fillColaDetails() {
		return ":" + (intervalosVerde.get(incomingRoadIds.get(semaforo))
				- tiempoConsumido);
	}
