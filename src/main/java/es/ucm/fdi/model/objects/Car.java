...
public class Car extends Vehicle {
	 ...
	 */
	public Car(int res, double fProb, int mFDur, long s, String id,
			int maxSpeed, String[] trayecto, RoadMap map) {
	...
	public Car(int res, double fProb, int mFDur, String id, int maxSpeed,
		...
		this(res, fProb, mFDur, System.currentTimeMillis(), id, maxSpeed,
				trayecto, map);
	}
