...
public enum EventType
{
	...
	public String toString()
	{
		switch(this)
		{
		case NEW_JUNCTION: 			return "new_junction";
		case NEW_ROAD:				return "new_road";
		case NEW_VEHICLE:			return "new_vehicle";
		case NEW_FAULT:				return "make_vehicle_faulty";
	...
	public static EventType eventType(String name)
	{
		...
		case "new_road": 			return NEW_ROAD;
		case "new_vehicle":			return NEW_VEHICLE;
		case "make_vehicle_faulty": return NEW_FAULT;
		default:					return EVENT_ERROR;								//conviene lanzar excepción
		}
