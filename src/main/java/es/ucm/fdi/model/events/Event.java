...
/**
 * Clase abstracta encargada de dar un formato común a los eventos que actuarán
 * posteriormente sobre el simulador. Todos los eventos tendrán que implementar
 * el método execute() alterando conforme a su función el mapa de la simulación.
 * 
...
public abstract class Event implements Describable {
	 ...
	 * 
	 * @param time
	 *            Debe ser un número entero mayor o igual que cero. Momento en
	 *            el que se ejecutará el evento
	 * @param tipo
	 *            Tipo del evento a construir.
	 * @see EventType
	 * */
