...
public class EventFactoryTest
{
	...
	public void parseIniSectionTest()
	{
		...
		/*Prueba 2: NewJunction
		IniSection s2 = new IniSection("new_road");
		
		s2.setValue("time", "0");
		s2.setValue("id"	, "r1");
		s2.setValue("src", "j1");
		s2.setValue("dest", "j2");
		s2.setValue("max_speed" , "50");
		s2.setValue("length", "200");
		...
		//Prueba 3: NewVehicle
		IniSection s3 = new IniSection("new_road");
		
		s3.setValue("time", "0");
		s3.setValue("id"	, "r1");
		s3.setValue("src", "j1");
		s3.setValue("dest", "j2");
		s3.setValue("max_speed" , "50");
		s3.setValue("length", "200");
