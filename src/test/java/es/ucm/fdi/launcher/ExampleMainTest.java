...
public class ExampleMainTest {
	...
	public void parseArgsTest() {
		...
		assertEquals("1.-Fichero de entrada mal",
				"src/main/resources/readStr/ex1.ini", ExampleMain.getInFile());
		assertEquals("1.-Fichero de salida mal",
				"src/main/resources/writeStr/outFile.ini",
		...
		args = line.split("\\s");
		ExampleMain.parseArgs(args);
		assertEquals("2.-Fichero de entrada mal",
				"src/main/resources/readStr/ex1.ini", ExampleMain.getInFile());
		assertEquals("2.-Fichero de salida mal",
				"src/main/resources/writeStr/ex1.out",
				ExampleMain.getOutFile());
		...
		args = line.split("\\s");
		ExampleMain.parseArgs(args);
		assertEquals("3.-Fichero de entrada mal",
				"src/main/resources/readStr/ex1.ini", ExampleMain.getInFile());
		...
		args = line.split("\\s");
		ExampleMain.parseArgs(args);
		assertEquals("4.-Fichero de entrada mal",
				"src/main/resources/readStr/ex1.ini", ExampleMain.getInFile());
		assertEquals("4.-Fichero de salida mal",
				"src/main/resources/writeStr/ex1.out",
				ExampleMain.getOutFile());
